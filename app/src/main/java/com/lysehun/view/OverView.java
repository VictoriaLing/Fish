...
import com.lysehun.fish.MainActivity;
...
public class OverView extends BaseView {
	...
	public OverView(Context context, GameSoundPool sounds) {
	...
	public void initBitmap() {
		// TODO Auto-generated method stub
		background = BitmapFactory.decodeResource(getResources(), R.drawable.b0);
